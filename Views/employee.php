...
forEach($sales as $sale){
  ...
  <tr 
    ...
    <td class='action_buttons'>
      ...
      <a class='action_button' data-id='$employee->employee_id' href='/businessManager/Views/employee.php?employee_id={$employee->employee_id}&sale_id={$sale->sale_id}&new_invoice=1'>Create invoice</a>
    </td>
  </tr>";
}
