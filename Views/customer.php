...
forEach($sales as $sale){
  ...
  <tr 
    class='clickable' 
    data-href='/businessManager/Views/sale.php?sale_id=$sale->sale_id' data-id='$sale->sale_id'>
    ...
    <td class='action_buttons'>
      ...
      <a class='action_button' href='/businessManager/Views/customer.php?customer_id={$customer->customer_id}&sale_id=$sale->sale_id'>Invoices</a>
    </td>
  </tr>";
}
