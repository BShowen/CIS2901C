...
<main>
  <?php 
    ...
    if($edit_customer_details){
      require __DIR__."/partials/_customer_details_edit.php";
    }else{
      require __DIR__."/partials/_customer_details.php";
    }
  
    require __DIR__.'/partials/_customer_sales.php';
  
    if($invoices_requested){ 
      require __DIR__.'/partials/_invoice.php'; 
    }

    if($create_invoice){
      require __DIR__.'/partials/_new_invoice_form.php';
    }
  ?>
</main>